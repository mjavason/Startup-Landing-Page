    ...
    <nav className="text-white bg-primary-500">
      <div className="max-w-[100%] flex justify-between items-center p-5 border-b-2 border-[#6757AE]">
        ...
        <div className="order-3 flex gap-0 md:gap-4">
          <Button variant="ghost" className="text-white hover:text-black border-none">
            Login
          </Button>
          <Button variant="bordered" className="text-white border-white hover:bg-primary-600">
            Sign Up
          </Button>
        </div>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="fixed top-0 left-0 h-screen w-[40%] bg-gray-900 flex flex-col items-center justify-center space-y-6 shadow-lg transition-all duration-300 ease-in-out">
          ...
          {/* Close Button */}
          <Button variant="ghost" className="text-white mt-4" onPress={() => setIsOpen(false)}>
            Close
          </Button>
        </div>
      )}
